...
CUDA_VISIBLE_DEVICES=3 python main_mpi3dreal.py --datapath "./data/MPI3d_real_complex/" --model-id "mpi3d_perturbation_3_tr2" --bias-type "perturbation" --bias-id 3
wait
CUDA_VISIBLE_DEVICES=3 python main_mpi3dreal.py --datapath "./data/MPI3d_real_complex/" --model-id "mpi3d_perturbation_3_tr3" --bias-type "perturbation" --bias-id 3
wait
