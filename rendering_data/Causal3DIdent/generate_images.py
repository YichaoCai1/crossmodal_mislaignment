...
def initialize_renderer(
    ...
    include_lights=True,
    width=128,   # width=224,
    height=128,  # height=224,
    render_tile_size=32,  # render_tile_size=64,
    use_gpu=False,
    render_num_samples = 128,  # render_num_samples=512,
    render_min_bounces=4,    # render_min_bounces=8,
    render_max_bounces=4,   # render_max_bounces=8,
    ground_texture=None,
):
